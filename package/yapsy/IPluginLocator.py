...
class IPluginLocator(object):
    ...
    def locatePlugins(self):
        ...
        raise NotImplementedError(
            "locatePlugins must be reimplemented by %s" %
            self)
    ...
    def gatherCorePluginInfo(self, directory, filename):
        ...
        """
        raise NotImplementedError(
            "gatherPluginInfo must be reimplemented by %s" %
            self)
    ...
    def setPluginPlaces(self, directories_list):
        ...
        """
        log.warn(
            "setPluginPlaces was called but '%s' doesn't implement it." %
            self)
    ...
    def updatePluginPlaces(self, directories_list):
        ...
        """
        log.warn(
            "updatePluginPlaces was called but '%s' doesn't implement it." %
            self)
