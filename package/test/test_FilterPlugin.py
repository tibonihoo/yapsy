...
#		print os.path.join(os.path.dirname(os.path.abspath(__file__)),"plugins")
    ...
    def plugin_loading_check(self):
        ...
        self.assertEqual(
            len(self.filteredPluginManager.getPluginsOfCategory(sole_category)), 1)
    ...
    def testRejectPlugin(self):
        ...
        self.assertEqual(
            nrRejected, len(
                self.filteredPluginManager.rejectedPlugins))
    ...
    def testRemovePlugin(self):
        ...
        self.assertEqual(
            nrCandidates, len(
                self.filteredPluginManager.getPluginCandidates()))
    ...
    def testAppendRejectedPlugin(self):
        ...
        for plugin in rejected:
            self.filteredPluginManager.removePluginCandidate(plugin)
        self.assertEqual(
            len(self.filteredPluginManager.getRejectedPlugins()), 0)
